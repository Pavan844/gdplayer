...
<title><?php echo $website_title.' '.$website_version.' | Desktop Site'; ?></title>
...
<center>
  <div class="container">
   <h1 class="welcome"><?php echo $website_title.' '.$website_version; ?></h1>
   <p class="muzile" style='display:none;'><?php echo $website_version; ?>
</p>
  </div>

<!--
<h3><?php echo $website_title; ?></h3>
<h4><?php echo $website_version; ?></h4> 
-->
</center>
...
<input class="input-Height" type="text" name="height" id="height" value="900px" style="width: 25%;
  padding: 3px 5px;
  margin: 8px 0;
  display: inline-block;
  border: 1px solid #ccc;
...
<fieldset>
   ...
   <p class="divheading" style="text-align:center;">Preview</p>
...
<p class="divheading" style="text-align:center;">Embed URL</p>
...
<fieldset>
<p class="divheading" style="text-align:center;">Embed Code</p>
...
<p class="copyright">© <?php echo date('Y'); ?> <a href="https://www.youtube.com/channel/UCMMS04AArq9iMUnXFsT8ybA" target="_blank" title="Colorlib"><?php echo $author; ?></a></p>
</form>
</div>  
